...
class config(object):
	def __init__(self, params = {}):
		...
		self.params["device"] = "cuda:0" # cuda:0, cpu
		...
		self.params["model_backbone"] = "resnet" # fasterrcnn_resnet50_fpn, resnet
		...
		self.params["aug_policy"]["oneOF"] = [1.0, 0.5, 0.5]
		...
		self.params["aug_policy"]["Blur"] = [[11,13], True, 'constant', -1024, 0.1]
